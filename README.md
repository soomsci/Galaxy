...
**우리은하 3D** 탭(`/#galaxy`)은 은하 중심을 기준으로 자유롭게 회전하는 교육용 모형입니다. 드래그 또는 방향키로 회전하고, 휠·핀치·확대 슬라이더로 거리를 조절합니다. 위·옆·아래 보기, 태양계 위치 표시, 자동 회전을 지원합니다. 나선팔과 별 분포는 단순화한 개념도입니다.
...
node scripts/check-galaxy-view.mjs
```
